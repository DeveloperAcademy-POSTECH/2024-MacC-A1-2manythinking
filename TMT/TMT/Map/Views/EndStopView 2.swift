...
// StopStatusEnum, EndStopView 코드만 크게 수정됨.
struct EndStopView2: View {
    ...
    private func mainColor(remainingStops: Int) -> (backgroundColor: Color, leftStopNumberColor: Color, leftStopTextColor: Color, destinationColor: Color, pinImage: String) {
        let status = StopStatusEnum2(remainingStops: remainingStops)
...
#Preview {
    EndStopView2(endStopNameKorean: "포항제철고등학교", endStopNameRomanized: "[Pohang Je-cheol Go-deung-hak-gyo", endStopNameNaver: "Pohang Jecheol High School", remainingStops: 4)
}
